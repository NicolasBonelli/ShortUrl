"""
Django settings for shorturl_backend project.
...
SECRET_KEY = 'django-insecure-ydg#zc%z#+q04@xx-jvzwn32woqoyf9*(zk)49q3t*rn-)+!-)'
...
ROOT_URLCONF = 'shorturl_backend.urls'
...
WSGI_APPLICATION = 'shorturl_backend.wsgi.application'
